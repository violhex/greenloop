...
const GREENLOOP_CORE = `# GREENLOOP — Agent Execution Workflow v2.3.0
...
const GREENLOOP_APPENDICES = `# GREENLOOP — Appendices (companion to GREENLOOP.md v2.3.0)
...
const GREENLOOP_SCHEMA = `{
  "_doc": "GREENLOOP state template (companion to GREENLOOP.md v2.3.0). Copy to .greenloop/state.json to initialize. Minimum viable schema — extend, don't shrink. Pipe-delimited strings show the allowed values for that field. Author: violhex (https://github.com/violhex) · MIT.",
...
const GREENLOOP_PROFILE_DESIGN = `# GREENLOOP — Domain Profile: DESIGN (companion to GREENLOOP.md v2.3.0)
